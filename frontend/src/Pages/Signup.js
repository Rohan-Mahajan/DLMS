...
function AddMember() {
  ...
  const addMember = async (e) => {
    ...
    if (
      ...
      try {
        ...
        setDobString(null);
        alert('Member Added');
        document.querySelector('addmember-form').reset()
      } catch (err) {
        console.log(err);
      }
    } else {
  ...
  return (
    <div>
      ...
      <h2 className='signupHeading'>Register Form</h2>
      <div className='signUpForm'>
      <form className="addMember-form" onSubmit={addMember}>
        <div className="semanticdropdown">
            <label htmlFor="userType" className='addmember-form-label'>
                User Type
            </label>
          <Dropdown
        ...
        <label className="addmember-form-label" htmlFor="semester">
        Semester<span className="required-field">*</span>
        </label>
        <br />
        <input
          className="addmember-form-input"
