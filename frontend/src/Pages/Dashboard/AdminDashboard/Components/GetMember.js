            ...
            <div style={memberId === null ? { display: "none" } : {}}>
                <div className="member-profile-content" id="profile@member" style={memberId === null ? { display: "none" } : {}}>
                    <div className="user-details-topbar">
                        <img className="user-profileimage" src={getProfilePic()} alt=""></img>
                        <div className="user-info">
                            ...
                            <p className="user-id">{memberDetails?.userType === "Student" ? memberDetails?.semester : ""} Semester</p>
                    ...
                    <div className="user-details-specific">
                        <div className="specific-left">
                            <div style={{ display: "flex", justifyContent: "space-between" }}>
                                <p style={{ display: "flex", flex: "1", flexDirection: "column" }}>
