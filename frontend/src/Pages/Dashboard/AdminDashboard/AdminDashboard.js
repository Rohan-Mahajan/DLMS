...
import GetMembersDetails from "./Components/GetMembersDetails";
...
import PrintBooks from './Components/PrintBooks';
        ...
        <div className="dashboard">
            <div className="dashboard-card">
                ...
                <div className={sidebar ? "dashboard-options active" : "dashboard-options"}>
                    ...
                    <p className={`dashboard-option ${active === "addcategory" ? "clicked" : ""}`} onClick={() => { setActive("addcategory"); setSidebar(false) }}><BookIcon className='dashboard-option-icon' />Add Category</p>
                    ...
                    <p className={`dashboard-option ${active === "printbooks" ? "clicked" : ""}`} onClick={() => { setActive("printbooks"); setSidebar(false) }}><AccountBoxIcon className='dashboard-option-icon' /> Print Books </p>
                    <p className={`dashboard-option ${active === "printmembers" ? "clicked" : ""}`} onClick={() => { setActive("printmembers"); setSidebar(false) }}><AccountBoxIcon className='dashboard-option-icon' /> Print Members </p>
                ...
                <div className="dashboard-option-content">
                    ...
                    <div className="dashboard-addmember-content" style={active !== "printbooks" ? { display: 'none' } : {}}>
                        <PrintBooks/>
                    </div>
                    <div className="dashboard-addmember-content" style={active !== "printmembers" ? { display: 'none' } : {}}>
                        <GetMembersDetails/>
                    </div>
